...
contract DeployCEAMigrationScript is Script {
    ...
    function run() external {
        ...
        console.log("CEA_IMPLEMENTATION:", verifiedImpl, verifiedImpl == address(ceaV2) ? "[OK]" : "[MISMATCH]");
        ...
        string memory filename = string(abi.encodePacked("deployments/", vm.toString(chainId), "_cea_migration.json"));
