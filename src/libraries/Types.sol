...
enum VerificationType {
    ...
    universalTxVerification     // Universal Executor Module verification (no signature required)
}
...
struct UniversalPayload {
    ...
    VerificationType vType;         // Type of verification to use before execution
}
