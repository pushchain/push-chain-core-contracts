...
contract UEAFactoryTest is Test {
    ...
    function testMultipleChainsSameVM() public {
        ...
        UniversalAccount memory ethAccount = UniversalAccount({
            CHAIN: "eip155:1", 
            ownerKey: ownerKey
        });
        
        UniversalAccount memory polyAccount = UniversalAccount({
            CHAIN: "eip155:137", 
            ownerKey: ownerKey
        });
    ...
    function testFactoryLifecycle() public {
        ...
        for (uint i = 0; i < 5; i++) {
            ...
            UniversalAccount memory account = UniversalAccount({
                CHAIN: chain,
    ...
    function testChainConfigChanges() public {
        ...
        UniversalAccount memory account2 = UniversalAccount({
            CHAIN: "eip155:42",
            ownerKey: owner2Key
        });
    ...
    function testMappingConsistency() public {
        ...
        UniversalAccount memory newAccount = UniversalAccount({
            CHAIN: "eip155:1",
    ...
    function testFactoryStateVerification() public {
        ...
        UniversalAccount memory otherAccount = UniversalAccount({
            CHAIN: "eip155:42",
