...
contract ForkUniversalCoreTest is Test, UpgradeableContractHelper {
    // =========================================================================
    // Push Chain Donut Testnet — Uniswap V3 Infrastructure
    // Source: pushchain/push-chain-swap-internal-amm-contracts test-addresses.json
    // =========================================================================
    ...
    // =========================================================================
    // PRC20 Token Addresses (official-prc20.json)
    // =========================================================================
    ...
    address constant USDT_ETH_TOKEN = 0xCA0C5E6F002A389E1580F0DB7cd06e4549B5F9d3;
    address constant USDC_ETH_TOKEN = 0x387b9C8Db60E74999aAAC5A2b7825b400F12d68E;
    address constant PETH_ARB_TOKEN = 0xc0a821a1AfEd1322c5e15f1F4586C0B8cE65400e;
    address constant PBNB_TOKEN = 0x7a9082dA308f3fa005beA7dB0d203b3b86664E36;
    address constant USDT_BASE_TOKEN = 0x2C455189D2af6643B924A981a9080CcC63d5a567;

    // =========================================================================
    // Pool Addresses (test-addresses.json)
    // =========================================================================
    ...
    address constant USDT_ETH_WPC_POOL = 0x2d46b2b92266f34345934F17039768cd631aB026;
    address constant USDC_ETH_WPC_POOL = 0x69B21660F49f2B8F60B0177Abc751a08EBEa0Ae3;
    address constant PETH_ARB_WPC_POOL = 0x1354c9A72F447f60F4811FC34b8C2e084FE338A3;
    address constant PBNB_WPC_POOL = 0x826edC20c926653f4ddC01b8d4C7Df31a403e7d6;
    ...
    function setUp() public {
        ...
        // Pin to a known block to use cached fork data and avoid RPC rate limits
