...
import {UniversalAccountId, UniversalPayload, VerificationType, UNIVERSAL_PAYLOAD_TYPEHASH} from "../src/libraries/Types.sol";
...
contract ProxyCallTest is Test {
    ...
    function setUp() public {
        ...
        UniversalAccountId memory user1Id = UniversalAccountId({
        ...
        UniversalAccountId memory user2Id = UniversalAccountId({
            chainNamespace: "eip155",
            chainId: "1",
            owner: user2Bytes
        });
