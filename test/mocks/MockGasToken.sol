...
contract MockGasToken is IPRC20 {
    ...
    function withdraw(bytes calldata, uint256) external pure returns (bool) {
        revert("Not implemented");
    }

    function getOutboundTxGasAndFees(address, uint256)
        external
        pure
        returns (address, uint256, uint256, uint256, string memory, uint256)
    {
        revert("Not implemented");
    }

    function UNIVERSAL_EXECUTOR_MODULE() external pure returns (address) {
        revert("Not implemented");
    }
    ...
    function TOKEN_TYPE() external pure returns (TokenType) {
        revert("Not implemented");
    }

    function HANDLER_CONTRACT() external pure returns (address) {
        revert("Not implemented");
    }

    function UNIVERSAL_CORE() external pure returns (address) {
        revert("Not implemented");
    }
