 ...
 *         pair against the old CEAFactory on-chain in a single run.
 *
 * USAGE:
 ...
 *
 * CONFIGURATION:
 *   Update OLD_CEA_FACTORY below per chain.
 */
contract VerifyAllOldCEAsScript is Script {
    address public OLD_CEA_FACTORY =
    ...
    function run() external view {
        ...
        console.log("Old CEAFactory:", OLD_CEA_FACTORY);
